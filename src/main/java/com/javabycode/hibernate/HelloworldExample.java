...
public class HelloworldExample {
	...
	public static void main(String[] args) {
		...
		HelloworldExample application = new HelloworldExample();

		/*
		 * Dump data by saving few objects with hibernate
		 */
		int id1 = application.saveStudent("Bill Gate", new Date(), "USA",
				"1111111");
		int id2 = application.saveStudent("Larry Page", new Date(), "France",
				"1111112");
		int id3 = application.saveStudent("Steve Job", new Date(), "England",
				"1111113");
		int id4 = application.saveStudent("David Pham", new Date(), "Canada",
				"1111114");
	 ...
	 */
	public int saveStudent(String name, Date enteringDate, String nationality,
			String code) {
	...
	public List<Student> getAllStudents() {
		...
		List<Student> employees = (List<Student>) session.createQuery(
				"FROM Student s ORDER BY s.id ASC").list();
